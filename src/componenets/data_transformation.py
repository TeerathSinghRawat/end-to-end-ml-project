...
class DataTransformationConfig:
    preprocessor_ob_filepath=os.path.join('artifacts','preprocessor.pkl')
...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            preprocessor_obj=self.get_data_transformer_ob()
            ...
            logging.info("preprocessing obj on train and test df")
